...
@Component({
  ...
  imports: [FormsModule, CommonModule, NgIf, ReactiveFormsModule, InputComponent, InputDateComponent, InputCheckboxComponent, InputSelectComponent, InputSearchComponent, InputNumberComponent, InputNumberComponent],
